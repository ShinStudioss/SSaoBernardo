...
if global.pause = false{
	...
	draw_sprite_ext(spr_hudIcon, 0, 32, 25,coracaoSize,coracaoSize,0,c_white,2.5-coracaoSize);
	...
	draw_sprite_ext(spr_hudIcon, 1, 32, 60, 1, 1, 0, c_white, alphaCorrida);
	...
	draw_sprite(spr_hudIcon, 2, 32+random_range(-fomeShake,fomeShake), 95+random_range(-fomeShake,fomeShake));
