...
if global.pause = false{
	draw_sprite_stretched_ext(spr_inventario,0,device_mouse_x_to_gui(0),device_mouse_y_to_gui(0),40+string_width(display_text),48,c_white,alpha)
	draw_set_halign(fa_left)
	draw_set_valign(fa_top)
	draw_set_font(fnt_interacoes)
	draw_text_colour(device_mouse_x_to_gui(0)+20,device_mouse_y_to_gui(0),display_text,c_black,c_black,c_black,c_black,alpha)
