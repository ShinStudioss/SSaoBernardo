...
#macro CLE_VERSION "v2.2"
#macro CLE_RELEASE_DATE "17, December, 2025"

show_debug_message($"Crystal Lighting Engine {CLE_VERSION} | Copyright (C) 2026 Mozart Junior (@foxyofjungle)");
