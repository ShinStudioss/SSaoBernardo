...
#region Macros
	...
	#macro LIGHT_SHADOW_SHADER_BASIC 1
	#macro LIGHT_SHADOW_SHADER_SMOOTH 2
	#macro LIGHT_SHADOW_SHADER_SPRITE 4
	#macro LIGHT_SHADOW_SHADER_SPRITE_BASIC (1 | 4)
	#macro LIGHT_SHADOW_SHADER_SPRITE_SMOOTH (2 | 4)
