...
uniform vec4 u_params2; // xDir, yDir, shadowDepthOffset, lightPenetration
...
void main() {
	...
	vec2 shadowPos = in_Colour.xy + (in_Colour.w * u_params2.xy + normalize(vec2(u_params2.y, -u_params2.x))*u_params.z*in_Colour2.w) * shadowLen;
